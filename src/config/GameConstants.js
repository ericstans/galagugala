...
export const GAME_CONFIG = {
  ...
  ENEMY_BULLET_GREEN_CHANCE: 0.1,
  ENEMY_BULLET_RED_CHANCE: 0.05,
  ENEMY_BULLET_YELLOW_CHANCE: 0.03,
  ENEMY_BULLET_GREEN_COOLDOWN: 240,
  ...
  ENEMY_DIVE_BASE_PROBABILITY: 0.06,
  ENEMY_DIVE_START_LEVEL: 1,
